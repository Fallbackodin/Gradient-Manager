...
export default function Contact() {
    ...
    const loadContact = contactArray.filter(
    ...
    const actualAdd = () => {
        addDoc(collection(firebase, "Contacts"), {
            ...newContact,
            uid: user.uid,
        });
        setAddDisplay(false);
    ...
    const actualEdit = () => {
        setDoc(doc(firebase, "Contacts", contactTemp.id), {
            ...newContact,
            userID: user.uid,
        });
    };
                ...
                <div className="contact-box-info">
                    {!editDisplay && (
                        <div className="contact-main">
                            ...
                            <div className="contact-row contact-first-row">
                            ...
                            <div>
                                {uniqueContact.map((contact) => (
                                    <div className="contact-row">
                                        <p className="contact-large-flex">
                                            {contact.first}
                                        </p>
                                        <p className="contact-large-flex">
                                            {contact.last}
